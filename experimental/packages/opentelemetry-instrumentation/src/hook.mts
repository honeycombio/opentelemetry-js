...
// The following code is import-in-the-middle's hook.mjs file
// We are providing it directly so that projects that use OpenTelemetry's Node SDK do not have to depend on
// import-in-the-middle explicitly when calling the --experimental-loader flag
...
const iitmURL = await metaResolve(
